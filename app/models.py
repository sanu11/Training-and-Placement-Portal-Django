...
class Student(models.Model):
	...
	fe_outof	  =		models.IntegerField(default=1400)
	se_marks	  = 	models.IntegerField(null=True,blank=True)
	se_outof	  = 	models.IntegerField(default=1500)
	te_marks 	  = 	models.IntegerField(null=True,blank=True)
	te_outof	  = 	models.IntegerField(default=750)
	be_marks	  = 	models.IntegerField(blank=True,null=True)
	be_outof	  = 	models.IntegerField(default=750)
